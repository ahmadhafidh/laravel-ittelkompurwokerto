...
<head>
    ...
    <title>Dashboard &mdash; ITTP</title>
    <!-- <link rel="shortcut icon" href="{{ asset('assets/img/idkodingloginimg2.png') }}" type="image/x-icon"> -->
    <!-- General CSS Files -->
...
<body style="background: #e2e8f0">
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('admin.dashboard.index') }}">ITTP</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('admin.dashboard.index') }}">ID</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        @can('dosenes.index')
                            <li class="{{ setActive('admin/dosen') }}"><a class="nav-link" href="{{ route('admin.dosen.index') }}"><i class="fas fa-folder"></i>
                        <span>Dosen</span></a>
                        </li>
                        @endcan
                        ...
                        @can('matakuliah.index')
                            <li class="{{ setActive('admin/matakuliah') }}"><a class="nav-link" href="{{ route('admin.matakuliah.index') }}"><i class="fas fa-folder"></i>
                        <span>Matakuliah</span></a>
                        </li>
                        @endcan

                        @can('waktu.index')
                            <li class="{{ setActive('admin/waktu') }}"><a class="nav-link" href="{{ route('admin.waktu.index') }}"><i class="fas fa-folder"></i>
                        <span>Waktu</span></a>
                        </li>
                        @endcan
            ...
            <center>
                <span>
                    Copyright &copy; 2021 <div class="bullet"></div> ITTP <div class="bullet"></div> All Rights
                    Reserved.
                </span>
            </center>
            </footer>
